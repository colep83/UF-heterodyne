...
exp_bounds = np.arange(4, 10, 1e-1) #lower bound, upper bound, step size in units of us
...
def AvgSNR2(images): #change to just the recorded images
    x_array=[355,356,357,358,359,360,361,362,363,364]
    y_array=[265,266,267,268,269,270,271,272,273,274]
    """
...
def SnakeChoice(paths_, StepSet_exp, StepSet_gain, ParamSpcDims, path_i, index_i):
